...
export const services: Service[] = [
  {
    ...
    description:
      'El servicio de asesoría integral parte del estudio de las necesidades del negocio para identificar la mejor manera de optimizar recursos. Incluye dirección financiera y fiscal externa, coordinación contable-laboral, elaboración de cuadro de mando y participación en comité mensual para el seguimiento estratégico del negocio.',
  ...
  },
  {
    ...
    description:
      'Nuestro equipo lleva la contabilidad de cada cliente al día, realizando conciliaciones, cierres mensuales y anuales, libros y depósitos de cuentas. Incluye reporting D+5 para la toma de decisiones más ágil. Para ello, determinamos los mejores métodos y procesos en función de cada tipo de cliente y adaptamos nuestras herramientas a los sistemas de gestión de cada empresa, garantizando una comunicación fluida en todo momento. Contamos con sistemas de lectura OCR de facturas físicas, sistemas de importación directa desde procesadores de texto u hojas de cálculo y traslado de bancos desde la web de cada banco.',
    image: '/v1760802190/bali/bali-asociados-presentacion-asesoria_ohtywl.jpg',
  },
  {
    name: 'Fiscal',
    ...
    description:
      'Partiendo del encuadre fiscal de las actividades de cada negocio, planificamos y presentamos todos los modelos tributarios (IS, IVA, IRPF y retenciones) para asegurar el cumplimiento con las obligaciones locales, autonoómicas o internacionales. Determinamos la tributación en operaciones singulares, gestionamos pagos fraccionados y te acompañamos en inspecciones y recursos. Además, nuestro equipo se mantiene actualizado en normativa tribuataria para facilitarte su conocimiento y evolución. Nuestro equipo vela por el cumplimiento de tus obligaciones tributarias',
    image: '/v1760802190/bali/bali-asociados-presentacion-asesoria_ohtywl.jpg',
  },
  {
    name: 'Laboral',
    ...
    description:
      'El equipo de Bali Asociados analiza cada negocio para determinar y gestionar todo lo necesario en el ámbito laboral. Altas de autónomos (RETA), elaboración de contratos o subtontrataciones, nóminas y seguros sociales, sanciones o despidos y conciliaciones. Elaboración de convenios y políticas retributivas. En el plano de la igualdad, análisis de brecha salarial, protocolos antiacoso, canales de denuncias y planes de igualdad.  También se da cobertura a la coordinación de Prevención de Riesgos Laborales y ERTE. Y se realizan auditorías de costes y laborales.',
    image: '/v1760802190/bali/bali-asociados-presentacion-asesoria_ohtywl.jpg',
  },
  {
    name: 'Constitución de empresas',
    intro:
      ' Apoyamos el emprendimiento mediante las vías más sencillas y seguras para constituir empresas o iniciar actividades económicas a título personal.',
    description:
      'Nuestro equipo te acompaña en la puesta en marcha de tu negocio, ya sea como autónomo o sociedad. Elegimos la forma jurídica más adecuada, elaboramos los estatutos, gestionamos altas censales, IAE y cuentas bancarias y ponemos en marcha compliant. Todo ello, simplificando y agilizando los trámites con garantía de seguridad.',
    image: '/v1760802190/bali/bali-asociados-presentacion-asesoria_ohtywl.jpg',
  },
  {
    ...
    description:
      'Partimos de un diagnóstico completo de la situación del negocio y el mercado, identificamos tu propuesta de valor y diseñamos la estrategia de pricing más efectiva. Desarrollamos un plan comercial integral, incluyendo embudos de conversión y un calendario de acciones. Alineando cada iniciativa con los objetivos del negocio para ganartizar resultados medibles.',
    image: '/v1760802190/bali/bali-asociados-presentacion-asesoria_ohtywl.jpg',
  },
];
